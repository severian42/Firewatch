...
export const ShieldExclamationIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
...
export const MapIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 16.382V5.618a1 1 0 00-1.447-.894L15 7m0 10l-6-3m6 3V7m0 10L9 7" />
    </svg>
);

export const FilterIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M3 3a1 1 0 011-1h12a1 1 0 011 1v3a1 1 0 01-.293.707L12 12.414V17a1 1 0 01-1.447.894l-4-2A1 1 0 016 15V6.414L3.293 3.707A1 1 0 013 3z" clipRule="evenodd" />
    </svg>
);
...
export const ChatBubbleBottomCenterTextIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.26c-1.131.079-2.274-.216-3.227-.792L11.25 14.51l-3.722-.261c-1.131-.079-2.274.216-3.227.792L.75 15.25l-.01-4.286c0-.97.616-1.813 1.5-2.097L4.5 7.5l3.75 3.75 3.75-3.75 3.75 1.011z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 7.5v6m15-6v6" />
    </svg>
);

export const QuestionMarkCircleIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
