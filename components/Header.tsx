  ...
  return (
    <header className="bg-gray-800 border-b border-gray-700 shadow-md px-4 py-3 sticky top-0 z-30">
      <div className="container mx-auto flex flex-col items-center gap-2 relative">
        <a href="https://github.com/dhrkc/Firewatch" target="_blank" rel="noopener noreferrer" className="absolute right-0 top-1/2 -translate-y-1/2 p-2 text-gray-400 hover:text-blue-400 transition-colors rounded-full">
